...
@yield('content')
          ...
          <div class="col-md-12">
            <div class="owl-partners owl-carousel">
                ...
                <div class="partner-item">
                    <img src="{{$reference->image}}" title="{{$reference->name}}" alt="{{$reference->name}}">
                  </div>
                @endforeach
            </div>
          </div>
    ...
    <div class="sub-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p>Tüm hakları saklıdır. &copy; 2023 | <a target="_blank" href="https://github.com/sametaltundag">Samet ALTUNDAĞ</a></p>
          </div>
        </div>
      </div>
    </div>
